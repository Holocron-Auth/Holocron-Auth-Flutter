              ...
              children: [
                    ...
                    children: [
                      Container(
                        margin: EdgeInsets.only(
                            top: 0.02 * height, left: 0.06 * width),
                        child: Checkbox(
                          value: isChecked,
                ...
                Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                      //  here convert bool isverified from false to true only then it'll let you go
                      //  that is enter the right otp
                      //  create a function that will extract the name , email and if possible image from the database
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => homeScreen1(name: name, number: number, email: email, image:image,)),
                        );
                      },
                      child: Text(
                        'Sign In',
